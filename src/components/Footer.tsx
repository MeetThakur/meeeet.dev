    ...
    <footer className="relative z-10 border-t border-black/5 dark:border-white/5 py-10 px-4 md:px-20">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4 flex-wrap justify-center">
          ...
          <a href={resumeData.duolingo} target="_blank" rel="noreferrer" aria-label="Duolingo" className="text-slate-400 hover:text-ink-dark dark:hover:text-ink-light transition-colors">
